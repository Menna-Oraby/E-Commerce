...
import '../pages/product_details_screen/product_details_screen.dart';

class FavoriteItem extends StatefulWidget {
  GetWishlist wishlist;

   FavoriteItem({super.key,required this.wishlist});
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              _buildImageContainer(imageCover:widget.wishlist.imageCover??''),
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      _buildItemHeader(title: widget.wishlist.title??''),
                      SizedBox(height: 5.h),
                      //_buildItemDetails(),
                      SizedBox(height: 5.h),
                      _buildItemPrice(price: widget.wishlist.price?.toDouble()??0.0),
                    ],
                  ),
                ),
              ),
    ...
    return Row(
      ...
      children: [
        ...
        Container(
          ...
          Center(child: AutoSizeText(' Add to Cart ',style: AppStyles.light16White,))),
        ),
      ],
    );
  }
