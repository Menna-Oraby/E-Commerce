...
class _WebServices implements WebServices {
  ...
  Future<WishlistActionResponseDto> addToWishlist(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(productRequest.toJson());
    final _options = _setStreamType<WishlistActionResponseDto>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'api/v1/wishlist',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late WishlistActionResponseDto _value;
    try {
      _value = WishlistActionResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<GetWishlistResponseDto> getWishlist(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'token': token};
    _headers.removeWhere((k, v) => v == null);
